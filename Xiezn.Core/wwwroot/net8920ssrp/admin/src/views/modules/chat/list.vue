        ...
        >
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
				:style='{"border":"0px solid rgba(254, 148, 34, .2)","cursor":"pointer","padding":"6px 6px 0 4px","margin":"6px 5px 6px 0","borderColor":"#fff","color":"#333","transition":"all 0.3s","outline":"none","borderRadius":"4px","background":"rgba(255,255,255,.9)","borderWidth":"1px","width":"auto","fontSize":"16px","borderStyle":"solid","height":"32px"}'
                size="small"
